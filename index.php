		...
		<div id="fh5co-page">
					...
					<ul class="slides">
						...
						<li style="background-image: url(images/slider1.jpg);">
							...
							<div class="desc">
								...
								<p><a href="#" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#book_modal">Book Now</a></p>
							</div>
							</div>
							</div>
							</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="testimony">
						...
						<p class="author"><cite>George Jose P. Montano</cite></p>
					</div>
					</div>
					...
					<div class="testimony">
						...
						<p class="author"><cite>Craig A. Abquina</cite></p>
					</div>
					</div>
					...
					<div class="testimony">
						<blockquote>
							&ldquo;I&apos;m sick of following my dreams, man. I&apos;m just going to ask where they&apos;re going and hook up with &apos;em later. Add some more gibberish&rdquo;
						</blockquote>
						<p class="author"><cite>Some Random Stranger</cite></p>
					</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="blog-grid" style="background-image: url(http://www.luxxu.net/blog/wp-content/uploads/2017/03/Inside-the-10-Most-Expensive-Hotels-in-the-World-5.jpg);">
					...
					<div class="col-md-4">
						<div class="blog-grid" style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhg9hZsiI68CsawAhCM72RIr4qyfQCsWQtag&usqp=CAU);">
							<div class="date text-center">
								<span>09</span>
								<small>Aug</small>
							</div>
					...
					<div class="col-md-4">
						<div class="blog-grid" style="background-image: url(https://www.legoland.com.my/media/rjqpaprj/1400-x-933-hotel-adventure-premium.jpg);">
							<div class="date text-center">
								<span>09</span>
								<small>Aug</small>
							</div>
