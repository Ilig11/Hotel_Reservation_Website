...
<body>
	<div id="fh5co-wrapper" style="overflow-x:visible">
	<div id="fh5co-page">
	<div id="fh5co-header">
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="col-md-12">
					...
					<p>We are so excited too accomodate you! See you soon!</p>
				...
				<div class="row">
                    <div class="col-md-7">
                        <button><a href="index.html">Update Reservation</a></button>
                        <button><a href="index.html">Delete Reservation</a></button>
                    </div>
                    <div class="col-md-5">
                        <button><a href="index.html">Looks Good</a></button>
                    </div>
                </div>
